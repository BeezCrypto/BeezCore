...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Beez features */
        {"beez", "masternode", &masternode, true, true, false},
        {"beez", "listmasternodes", &listmasternodes, true, true, false},
        {"beez", "getmasternodecount", &getmasternodecount, true, true, false},
        {"beez", "masternodeconnect", &masternodeconnect, true, true, false},
        {"beez", "masternodecurrent", &masternodecurrent, true, true, false},
        {"beez", "masternodedebug", &masternodedebug, true, true, false},
        {"beez", "startmasternode", &startmasternode, true, true, false},
        {"beez", "createmasternodekey", &createmasternodekey, true, true, false},
        {"beez", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"beez", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"beez", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"beez", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"beez", "getmasternodescores", &getmasternodescores, true, true, false},
        {"beez", "mnbudget", &mnbudget, true, true, false},
        {"beez", "preparebudget", &preparebudget, true, true, false},
        {"beez", "submitbudget", &submitbudget, true, true, false},
        {"beez", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"beez", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"beez", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"beez", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"beez", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"beez", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"beez", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"beez", "checkbudgets", &checkbudgets, true, true, false},
        {"beez", "mnsync", &mnsync, true, true, false},
        {"beez", "spork", &spork, true, true, false},
        {"beez", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"beez", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use beezd, or the -server option to beez-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> beez-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:45293/\n";
}
