...
// Copyright (c) 2016-2017 The Beez developers
...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_18_MIN_STAKE_AMOUNT) r = SPORK_18_MIN_STAKE_AMOUNT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_18_MIN_STAKE_AMOUNT") return SPORK_18_MIN_STAKE_AMOUNT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_18_MIN_STAKE_AMOUNT) return "SPORK_18_MIN_STAKE_AMOUNT";
