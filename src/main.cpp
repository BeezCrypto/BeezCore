...
#if defined(NDEBUG)
#error "Beez cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    }   else if (nHeight <= 21000 && nHeight > 0) {
        nSubsidy = 100 * COIN;
    }   else if (nHeight <= 518000 && nHeight > 21000) {
        nSubsidy = 10000 * COIN;
    }   else if (nHeight <= 1036000 && nHeight > 518000) {
        nSubsidy = 10500 * COIN;
    }   else if (nHeight <= 1554000 && nHeight > 1036000) {
        nSubsidy = 11000 * COIN;
    }   else if (nHeight <= 2072000 && nHeight > 1554000) {
        nSubsidy = 11500 * COIN;
    }   else if (nHeight <= 2590000 && nHeight > 2072000) {
        nSubsidy = 12000 * COIN;
    }   else if (nHeight <= 3108000 && nHeight > 2590000) {
        nSubsidy = 12500 * COIN;
    }   else if (nHeight <= 3626000 && nHeight > 3108000) {
        nSubsidy = 12000 * COIN;
    }   else if (nHeight <= 4144000 && nHeight > 3626000) {
        nSubsidy = 11500 * COIN;
    }   else if (nHeight <= 4662000 && nHeight > 4144000) {
        nSubsidy = 11000 * COIN;
    }   else if (nHeight <= 5180000 && nHeight > 4662000) {
        nSubsidy = 10500 * COIN;
    }   else if (nHeight <= 5698000 && nHeight > 5180000) {
        nSubsidy = 10000 * COIN;
    }   else if (nHeight <= 6216000 && nHeight > 5698000) {
        nSubsidy = 9000 * COIN;
    }   else if (nHeight <= 6734000 && nHeight > 6216000) {
        nSubsidy = 8000 * COIN;
    }   else if (nHeight <= 7252000 && nHeight > 6734000) {
        nSubsidy = 7000 * COIN;
    }   else if (nHeight <= 7770000 && nHeight > 7252000) {
        nSubsidy = 6000 * COIN;
    }   else if (nHeight <= 8288000 && nHeight > 7770000) {
        nSubsidy = 5000 * COIN;
    }   else if (nHeight <= 8806000 && nHeight > 8288000) {
        nSubsidy = 4800 * COIN;
    }   else if (nHeight <= 9324000 && nHeight > 8806000) {
        nSubsidy = 4600 * COIN;
    }   else if (nHeight <= 9842000 && nHeight > 9324000) {
        nSubsidy = 4400 * COIN;
    }   else {
        nSubsidy = 1 * COIN;
    }
