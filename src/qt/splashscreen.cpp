...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Beez Core");
    ...
    QString copyrightTextBeez = QChar(0xA9) + QString(tr(" 2019 The Beez Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 60, copyrightTextBeez);
