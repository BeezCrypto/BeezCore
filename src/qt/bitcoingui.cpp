                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Beez Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Beez address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and beez: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Beez Core"), this);
    aboutAction->setStatusTip(tr("Show information about Beez Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Beez"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Beez addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Beez addresses"));
    ...
    openAction->setStatusTip(tr("Open a Beez: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Beez Core help message to get a list with possible Beez command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Beez Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Beez network", "", count));
}
...
{
    QString strTitle = tr("Beez Core"); // default title
