...
In order to support loading of multiple wallets in beez-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is beez.cpp.
...
Changes to beez.cpp
----------------------
beez.cpp is the entry point into beez-qt, and as such, will require some minor modifications to provide hooks for
